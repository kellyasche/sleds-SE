...
Now I'm going to prep the employment data in order to join with the master dataset. So, let's import the original data. I will then filter so that I only have PersonID that have graduated from a high school in Southern MN. The "Employment-Southern.csv" file came from a script within that "Employment" folder, where I imported the very large employment dataset and then filtered the PersonID by Southern MN grads.
...
It shows that 79% of the individuals had a MN employment record at their graduation year. That percentage drops to 67% two years after graduation and only 39% had a MN employment record 7 years after graduation. The percentage of people with no MN employment record hovers around 20%.
...
The cross tabs indicate a relationship between RUCA category and percentage of individuals that have a MN employment record for each graduation year timeframe. The primary difference is that graduates from town/rural mix districts have a higher percentage of having a MN employment record after graduating high school.
...
The cross tabs indicate a relationship between EDR and percentage of individuals that have a MN employment record for each graduation year time frame. The primary difference is that EDR 9 tends to have a higher percentage of individuals with MN employment records.
