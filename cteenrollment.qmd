...
The next dataset is individuals that were enrolled in CTE courses. I'm first going to load the entire dataset, then clean it up, and then I will merge it with my master/Southern graduate dataset.
