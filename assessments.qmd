...
Okay, lets check out assessments. This is the entire assessment dataset, which I will first clean up and then join it with our master/Southern graduate dataset.
...
In the master dataset 9% of the individuals were identified as English Learners at some point in the original data.
...
Entirely urban mix districts had the highest percentage of graduates categorized as an English learner with 11%, this is followed by the othertwo RUCA categories with 8% of graduates.
...
The highest percentage of english learner graduates was found in EDR 10 with 10% of graduates, compared to 8% in EDR 9.
...
Math: 68% either met or exceeded the standard.
