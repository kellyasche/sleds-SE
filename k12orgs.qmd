...
First, lets see the distribution of the number of years attending a Southern High School within this dataset.

A large majority of students (\~120,000 students) attended a Southern MN High School for 3 years. A few attended for longer than that, which is largely due to students who attended a CTE course after they graduated for special training.
...
As expected, the median is 3 years while the average was just a bit higher with 3.03 years.
...
The ANOVA table indicates that there is a statistically significant difference in the average number of years students attended a Southern MN High School but it's really minor.
